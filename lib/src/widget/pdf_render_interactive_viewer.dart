...
/// See also:
///
///   * [PDFRenderInteractiveViewer.builder], whose builder is of this type.
///   * [WidgetBuilder], which is similar, but takes no viewport.
typedef PDFRenderInteractiveViewerWidgetBuilder = Widget Function(BuildContext context, Quad viewport);
...
/// {@end-tool}
@immutable
class PDFRenderInteractiveViewer extends StatefulWidget {
  /// Create an InteractiveViewer.
  ///
  /// The [child] parameter must not be null.
  PDFRenderInteractiveViewer({
    Key? key,
  ...
  PDFRenderInteractiveViewer.builder({
    Key? key,
    this.clipBehavior = Clip.hardEdge,
    this.alignPanAxis = false,
    this.boundaryMargin = EdgeInsets.zero,
    ...
    this.scaleEnabled = true,
    this.transformationController,
    required PDFRenderInteractiveViewerWidgetBuilder this.builder,
  })  : assert(alignPanAxis != null),
        assert(builder != null),
        assert(minScale != null),
        assert(minScale > 0),
  ...
  ///
  /// Passed with the [PDFRenderInteractiveViewer.builder] constructor. Otherwise, the
  ...
  ///
  /// If the [PDFRenderInteractiveViewer.builder] constructor is used, then this will be
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      PDFRenderInteractiveViewer.getNearestPointOnLine(point, quad.point0, quad.point1),
      PDFRenderInteractiveViewer.getNearestPointOnLine(point, quad.point1, quad.point2),
      PDFRenderInteractiveViewer.getNearestPointOnLine(point, quad.point2, quad.point3),
      PDFRenderInteractiveViewer.getNearestPointOnLine(point, quad.point3, quad.point0),
    ];
  ...
  @override
  State<PDFRenderInteractiveViewer> createState() => _PDFRenderInteractiveViewerState();
}

class _PDFRenderInteractiveViewerState extends State<PDFRenderInteractiveViewer>
  ...
  void _onScaleUpdate(ScaleUpdateDetails details) {
    ...
    switch (_gestureType!) {
      case _GestureType.scale:
        ...
        print("${(1 - scaleChange).abs()}");
        if ((1 - scaleChange).abs() > 0.11) {
  ...
  @override
  void didUpdateWidget(PDFRenderInteractiveViewer oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.child != null) {
      child = _PDFRenderInteractiveViewerBuilt(
        childKey: _childKey,
      ...
      child = LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          return _PDFRenderInteractiveViewerBuilt(
            childKey: _childKey,
            clipBehavior: widget.clipBehavior,
            constrained: widget.constrained,
            matrix: matrix,
...
class _PDFRenderInteractiveViewerBuilt extends StatelessWidget {
  const _PDFRenderInteractiveViewerBuilt({
    Key? key,
    required this.child,
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return PDFRenderInteractiveViewer.getAxisAlignedBoundingBox(boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside = PDFRenderInteractiveViewer.getNearestPointInside(point, boundary);
